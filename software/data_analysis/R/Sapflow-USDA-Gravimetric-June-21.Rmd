---
title: "Sapflow - USDA Gravimetric - Run 4"
...
sapflow_usda_2022_hr_19<-  read_csv('./data/june-2022-gravimetric/heatlog_USDA_19_5_21_to6_14_2022_Scale2_Scale8.csv')
# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_hr_19$dateP <- as_datetime(sapflow_usda_2022_hr_19$endofheatpulse, tz="America/Denver")


sapflow_usda_2022_hr_20<-  read_csv('./data/january-2022-gravimetric/heatlogUSDA20 to 1-5-22.csv')
# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_hr_20$dateP <- as_datetime(sapflow_usda_2022_hr_20$endofheatpulse, tz="America/Denver")


sapflow_usda_2022_hr_25<-  read_csv('./data/january-2022-gravimetric/heatlogUSDA25 to 1-5-22.csv')
# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_hr_25$dateP <- as_datetime(sapflow_usda_2022_hr_25$endofheatpulse, tz="America/Denver")


sapflow_usda_2022_hr_36<-  read_csv('./data/january-2022-gravimetric/heatlogUSDA36 to 1-5-22.csv')
# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_hr_36$dateP <- as_datetime(sapflow_usda_2022_hr_36$endofheatpulse, tz="America/Denver")
...
```{r pressure, echo=FALSE}
sapflow_usda_2022_19<-  read_csv('./data/january-2022-gravimetric/datalogUSDA19 to 1-5-22.csv')

# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_19$dateP <- as_datetime(sapflow_usda_2022_19$rtcUnixTimestamp, tz="America/Denver")


sapflow_usda_2022_20<-  read_csv('./data/january-2022-gravimetric/datalogUSDA20 to 1-5-22.csv')

# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_20$dateP <- as_datetime(sapflow_usda_2022_20$rtcUnixTimestamp, tz="America/Denver")



sapflow_usda_2022_25<-  read_csv('./data/january-2022-gravimetric/datalogUSDA25 to 1-5-22.csv')

# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_25$dateP <- as_datetime(sapflow_usda_2022_25$rtcUnixTimestamp, tz="America/Denver")


sapflow_usda_2022_32<-  read_csv('./data/january-2022-gravimetric/datalogUSDA32 to 12-5-21.csv')

# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_32$dateP <- as_datetime(sapflow_usda_2022_32$rtcUnixTimestamp, tz="America/Denver")

sapflow_usda_2022_36<-  read_csv('./data/january-2022-gravimetric/datalogUSDA36 to 1-5-22.csv')

# Tell R studio that timestamp is already in MDT
sapflow_usda_2022_36$dateP <- as_datetime(sapflow_usda_2022_36$rtcUnixTimestamp, tz="America/Denver")
...
```{r }
sapflow_usda_hr_2022 <-  rbind(sapflow_usda_2022_hr_19,
                            sapflow_usda_2022_hr_20,
                            sapflow_usda_2022_hr_25,
                            sapflow_usda_2022_hr_36)
...
```{r }
sapflow_usda_hr_2022 %>% mutate(meanhr = mhr) %>%
  filter(!meanhr =='NaN') %>% mutate(mr=as.numeric(meanhr)) %>%
     mutate(node = as.factor(nodeid),Vh = log(mr),hr = hour(dateP),yr = year(dateP),dy = day(dateP)) %>%
      filter(date(dateP) > "2021-12-12" & date(dateP) < "2021-12-28" ) %>%
  #filter(nodeId %in% c("sapflow-dotmote-labs-2" ,"sapflow-dotmote-labs-3", "sapflow-dotmote-labs-4","sapflow-dotmote-labs-5")) %>%
  ggplot() + geom_point(aes(dateP,1/mr,color=node) )  +
  facet_grid(dy~node) +
  theme_classic() + labs(x="Date",y="Mean HR", title = "Node 19,20,25 and 36 USDA - Gravimetric Maize", caption="Source : dotmotelabs.com") +
...
sapflow_usda_hr_2022 %>% mutate(meanhr = mhr) %>%
  filter(!meanhr =='NaN') %>% mutate(mr=as.numeric(meanhr)) %>%
     mutate(node = as.factor(nodeid),Vh = log(mr),hr = hour(dateP)) %>%
      filter(date(dateP) == "2021-12-14" ) %>%
  #filter(nodeId %in% c("sapflow-dotmote-labs-2" ,"sapflow-dotmote-labs-3", "sapflow-dotmote-labs-4","sapflow-dotmote-labs-5")) %>%
  ggplot() + geom_point(aes(dateP,1/mr,color=node) )  +
  facet_grid(~node) +
  theme_classic() + labs(x="Date",y="Mean HR", title = "Node 19,20,25 and 36 USDA - Gravimetric Maize", caption="Source : dotmotelabs.com") +
...
```{r , echo=TRUE}
colnames(sapflow_usda_hr_2022) <- c("meanHeatRatio" ,"endofheatpulse", "startofheatpulse", "nodeId" ,         "dateP" )
...
usda_19_offset <- sapflow_usda_hr_2022 %>%  mutate(meanhr = meanHeatRatio,hr = hour(dateP)) %>%
  filter(!meanhr =='NaN') %>% 
  filter(nodeId %in% c("sapflow-usda-19"))  %>% 
  filter( hr %in% c(0,1,2)) %>% summarise(mhr = mean(meanhr))


usda_20_offset <- sapflow_usda_hr_2022 %>%  mutate(meanhr = meanHeatRatio,hr = hour(dateP)) %>%
  filter(!meanhr =='NaN') %>% 
  filter(nodeId %in% c("sapflow-usda-20"))  %>%
  filter( hr %in% c(0,1,2)) %>% summarise(mhr = mean(meanhr))

usda_25_offset <- sapflow_usda_hr_2022 %>%  mutate(meanhr = meanHeatRatio,hr = hour(dateP)) %>%
  filter(!meanhr =='NaN') %>% 
  filter(nodeId %in% c("sapflow-usda-25"))  %>% 
  filter( hr %in% c(0,1,2)) %>% summarise(mhr = mean(meanhr))

usda_36_offset <- sapflow_usda_hr_2022 %>%  mutate(meanhr = meanHeatRatio,hr = hour(dateP)) %>%
  filter(!meanhr =='NaN') %>% 
  filter(nodeId %in% c("sapflow-usda-36"))  %>% 
  filter( hr %in% c(0,1,2)) %>% summarise(mhr = mean(meanhr))


sapflow_usda_2022_adjusted <- sapflow_usda_hr_2022
sapflow_usda_2022_adjusted$hr = hour(sapflow_usda_hr_2022$dateP)
sapflow_usda_2022_adjusted$mr <- 0

sapflow_usda_2022_adjusted[sapflow_usda_2022_adjusted$nodeId == "sapflow-usda-19",]$mr =  sapflow_usda_2022_adjusted[sapflow_usda_hr_2022$nodeId == "sapflow-usda-19",]$meanHeatRatio + (1-as.numeric(usda_19_offset))

sapflow_usda_2022_adjusted[sapflow_usda_2022_adjusted$nodeId == "sapflow-usda-20",]$mr =  sapflow_usda_2022_adjusted[sapflow_usda_hr_2022$nodeId == "sapflow-usda-20",]$meanHeatRatio + (1-as.numeric(usda_20_offset))

sapflow_usda_2022_adjusted[sapflow_usda_2022_adjusted$nodeId == "sapflow-usda-25",]$mr =  sapflow_usda_2022_adjusted[sapflow_usda_hr_2022$nodeId == "sapflow-usda-25",]$meanHeatRatio + (1-as.numeric(usda_25_offset))

sapflow_usda_2022_adjusted[sapflow_usda_2022_adjusted$nodeId == "sapflow-usda-36",]$mr =  sapflow_usda_2022_adjusted[sapflow_usda_hr_2022$nodeId == "sapflow-usda-36",]$meanHeatRatio + (1-as.numeric(usda_36_offset))



#SE 
sapflow_usda_2022_adjusted_se <- summarySE(sapflow_usda_2022_adjusted, measurevar="mr", groupvars=c("nodeId","hr"))
...
lm(sapflow_usda_2022_adjusted$meanHeatRatio~sapflow_usda_2022_adjusted$mr)
...
sapflow_usda_2022_adjusted %>% mutate(yr = year(dateP),mth = month(dateP),dy  = day(dateP)) %>%
  filter(yr %in% c(2021) & mth %in% c(12) & dy %in% c(14:28:28)) %>%
...
guides(fill = guide_legend(keywidth = 1, keyheight = 1),
    linetype=guide_legend(keywidth = 3, keyheight = 1))
ggsave("figs/usda-graivimetric-Maize-vh-smoothed-2022.png", width = 20, height = 20, units = "cm")
...
guides(fill = guide_legend(keywidth = 1, keyheight = 1),
    linetype=guide_legend(keywidth = 3, keyheight = 1))
ggsave("figs/usda-graivimetric-Maize-stress-event-2022.png", width = 20, height = 20, units = "cm")
...
ggsave("figs/usda-graivimetric-Maize-flow-long-duration-2022.jpg", width = 35, height = 20, units = "cm")
